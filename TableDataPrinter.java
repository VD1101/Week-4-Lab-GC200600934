...
public class TableDataPrinter {
    ...
    static final String URL = "jdbc:mysql://localhost:3306/EmployeeDB"; // Replace 'testdb' with your database name
    static final String USER = "root"; // Replace with your MySQL username
    static final String PASSWORD = "Vansh$1101"; // Replace with your MySQL password
